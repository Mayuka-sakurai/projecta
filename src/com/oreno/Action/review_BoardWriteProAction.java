...
public class review_BoardWriteProAction implements Action {
	...
	public ActionForward execute(HttpServletRequest request,HttpServletResponse response) throws Exception{
		...
		review_BoardBean boardBean = null;
		String realFolder = "";
		...
		boardBean = new review_BoardBean();
